...
double supercurrent(const vector<double> &arrayOfWires, const vector<double> &criticalPhases, const vector<int> &vorticity_arr, double initialPhaseDiff, double B);
vector<double> current_v_phase(const vector<double> &arrayOfWires, const vector<double> &criticalPhases, const vector<int> &vorticity_arr, const vector<double> &initialPhaseDiffs, double B);
pair<vector<double>, vector<double>> MagField_v_Critical_Current(const vector<double> &arrayOfWires, const vector<double> &criticalPhases, const vector<int> &vorticity_arr, const vector<double> &initialPhaseDiffs, const vector<double> &MagField);
